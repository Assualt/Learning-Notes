...
size_t Buffer::readableBytes() const { return m_nWriteIndex - m_nReadIndex; }
...
size_t Buffer::prependableBytes() const { return m_nReadIndex; }

const char *Buffer::begin() const { return &*m_vBuffer.begin(); }

char *Buffer::begin() { return &*m_vBuffer.begin(); }

const char *Buffer::peek() const { return begin() + m_nReadIndex; }

const char *Buffer::beginWrite() const { return begin() + m_nWriteIndex; }
...
base::StringPiece Buffer::toStringPiece() const { return base::StringPiece(peek(), peek() + readableBytes()); }
...
Buffer &Buffer::appendInt8(int8_t x) { return append(&x, sizeof(x)); }
...
size_t Buffer::internalCapacity() const { return m_vBuffer.capacity(); }
