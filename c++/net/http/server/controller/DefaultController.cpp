...
bool FavicoIndex::onPost(const HttpRequest &, HttpResponse &res, const HttpConfig &cfg) {
    return true;
}

bool FavicoIndex::onPut(const HttpRequest &, HttpResponse &res, const HttpConfig &cfg) {
    return true;
}