...
bool DefaultController::onPut(const HttpRequest &, HttpResponse &res, const HttpConfig &cfg) { return true; }
...
bool FileIndex::onGet(const HttpRequest &request, HttpResponse &response, const HttpConfig &config) {
    ...
    if (!utils::FileExists(strRequestPath)) {
        return false;
    }
...
bool FileIndex::onPut(const HttpRequest &, HttpResponse &res, const HttpConfig &cfg) { return true; }
...
bool FavicoIndex::onPost(const HttpRequest &, HttpResponse &res, const HttpConfig &cfg) { return true; }

bool FavicoIndex::onPut(const HttpRequest &, HttpResponse &res, const HttpConfig &cfg) { return true; }