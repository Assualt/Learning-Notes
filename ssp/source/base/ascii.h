...
#ifndef SSP_TOOLS_ASCII_H
#define SSP_TOOLS_ASCII_H
...
inline char ascii_tolower(unsigned char c) { return internal::kToLower[ c ]; }

inline char ascii_toupper(unsigned char c) { return internal::kToUpper[ c ]; }

} // namespace ssp::base

#endif //SSP_TOOLS_ASCII_H
